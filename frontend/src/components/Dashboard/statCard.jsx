...
export default function StatCard({ title, value, color,icon, isLoading }) {
  const colors = colorClasses[color];
  const Icon = icon;
  
  return (
    <Card className={`hover:shadow-lg transition-all duration-300 border-2 ${colors.borderLight} ${colors.bgLight} group`}>
